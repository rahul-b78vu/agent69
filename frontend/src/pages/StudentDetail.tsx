    ...
    <div className="student-profile-wrapper space-y-8 relative">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-semibold text-indigo-700 student-glass-pill">
            <Sparkles className="w-3 h-3 text-indigo-500" />
            Glassmorphic Baseline
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {student.current_signals.map((sig) => {
            ...
            return (
              <div
                key={sig.signal_type}
                className="student-glass-card p-5 rounded-2xl flex flex-col justify-between interactive-card hover:-translate-y-1 relative overflow-hidden group"
              >
